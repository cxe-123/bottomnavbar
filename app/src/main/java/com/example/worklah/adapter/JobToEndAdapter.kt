...
class JobToEndAdapter(
    private val context: Context,
    private val dataset: List<JobClaimed>
) : RecyclerView.Adapter<JobToEndAdapter.ItemViewHolder>() {

    private var db = FirebaseFirestore.getInstance()

    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ItemViewHolder {
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.job_to_end_card, viewGroup, false)
    ...
    override fun onBindViewHolder(viewHolder: ItemViewHolder, position: Int) {
        ...
        viewHolder.buttonEnd.setOnClickListener {
            AlertDialog.Builder(context)
                ...
                .setMessage("Are you sure to end the job, ${dataset[position].jobName}?")
                .setPositiveButton("Yes") { dialog, _ ->
                    ...
                    val data = hashMapOf(
                        ...
                        "jobStartDate" to dataset[position].jobStartDate,
                        "jobEndDate" to LocalDate.now().format(DateTimeFormatter.ofPattern("dd MMM"))
                    )
                    ...
                    //delete from JobToEndList

                    db.collection("JobToEndList").document(dataset[position].jobId!!)
                        .delete()
                    ...
                    Toast.makeText(context, "Job is ended.", Toast.LENGTH_SHORT).show()
                    dialog.dismiss()
                }
                .setNegativeButton("No") { dialog, _ ->
                    Toast.makeText(context, "Job is not ended.", Toast.LENGTH_SHORT).show()
                    dialog.dismiss()
                }
                .create()
                .show()
    ...
    class ItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val buttonEnd: Button = view.findViewById(R.id.list_item_button_end)
        //val itemView = view
    }
}